...
dialog_acts = {
    'restaurant': ['inform-specific', 'inform-addition','request-specify','request-select', 'nooffer', 'nooffer-relevant'],
    'hotel': ['inform-specific', 'inform-addition', 'request-specify', 'request-select','nooffer', 'nooffer-relevant'],
    'attraction': ['inform-specific', 'inform-addition', 'request-specify', 'request-select','nooffer', 'nooffer-relevant'],
    'train': ['inform-specific', 'inform-addition', 'request-specify', 'request-select','nooffer', 'nooffer-relevant'],
    'taxi': ['inform-specific', 'inform-addition', 'request-specify','cross-domain'],
    # 'police': ['inform', 'request'],
    # 'hospital': ['inform', 'request'],
    'booking': ['inform-specific', 'inform-addition', 'request-specify','nooffer', 'nooffer-relevant','cross-domain'],
...
dialog_act_params = {
    'inform-specific': all_slots + ['choice', 'open'] ,
    'inform-addition': all_slots + ['choice', 'open'] ,
    'request-specify': all_infslot+['choice', 'price'],
    'nooffer': all_slots + ['choice'],
    'nooffer-relevant': all_slots + ['choice', 'open'],
    'request-select': all_slots +['choice'],
    'cross-domain': all_slots + ['choice'],
